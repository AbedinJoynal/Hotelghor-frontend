        ...
        <div className="Room">
            ...
            <section className="desc_main">
                <article className="descLeft">
                    ...
                    <p>
                        Welcome back to our oceanside resort, in the heart of
                        Chittagong's bustling, breathtaking city. Nestled between
                        the dramatic peaks of Table Mountain and the roaring
                        Ocean, you’ll spend warm leisurely days by
                        glistening pools or basked in relaxation at our spa, and
                        balmy evenings sampling local flavours at our exquisite
                        restaurants & Lounge. Let us
                        show you another side to Chittagong. Here&Now.
                    </p>
                </article>
